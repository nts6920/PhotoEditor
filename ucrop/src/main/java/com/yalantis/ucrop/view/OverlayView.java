 ...
 * <p/>
 * This view is used for drawing the overlay on top of the image. It may have frame, ucrop_ic_rotate guidelines and dimmed area.
...
//        mCropRectMinSize = getResources().getDimensionPixelSize(R.dimen.ucrop_default_crop_rect_min_size);
        mCropRectMinSize = getResources().getDimensionPixelSize(R.dimen.ucrop_height_crop_aspect_ratio_text);
    ...
    @Deprecated
    /***
     * Please use the new method {@link #getFreestyleCropMode() getFreestyleCropMode} method as we have more than 1 freestyle ucrop_ic_rotate mode.
     */
    ...
    @Deprecated
    /***
     * Please use the new method {@link #setFreestyleCropMode setFreestyleCropMode} method as we have more than 1 freestyle ucrop_ic_rotate mode.
     */
     ...
     *
     * @param showCropFrame - set to true if you want to see a ucrop_ic_rotate frame rectangle on top of an image
     */
     ...
     *
     * @param dimmedColor - desired color of dimmed area around the ucrop_ic_rotate bounds
     */
    ...
    /**
     * Setter for ucrop_ic_rotate frame stroke width
     */
    ...
    /**
     * Setter for ucrop_ic_rotate grid stroke width
     */
    ...
    /**
     * Setter for ucrop_ic_rotate frame color
     */
    ...
    /**
     * Setter for ucrop_ic_rotate grid color
     */
    ...
    /**
     * Setter for ucrop_ic_rotate grid corner color
     */
    ...
    /**
     * This method sets aspect ratio for ucrop_ic_rotate bounds.
     *
     * @param targetAspectRatio - aspect ratio for image ucrop_ic_rotate (e.g. 1.77(7) for 16:9)
     */
    ...
    /**
     * This method setups ucrop_ic_rotate bounds rectangles for given aspect ratio and view size.
     * {@link #mCropViewRect} is used to draw ucrop_ic_rotate bounds - uses padding.
     */
    ...
    /**
     * Along with image there are dimmed layer, ucrop_ic_rotate bounds and ucrop_ic_rotate guidelines that must be drawn.
     */
    @Override
...
//        }
    ...
    /**
     * This method draws dimmed area around the ucrop_ic_rotate bounds.
     *
    ...
    /**
     * This method draws ucrop_ic_rotate bounds (empty rectangle)
     * and ucrop_ic_rotate guidelines (vertical and horizontal lines inside the ucrop_ic_rotate bounds) if needed.
     *
     * @param canvas - valid canvas object
     */
    protected void drawCropGrid(@NonNull Canvas canvas) {
        float x1 = mCropViewRect.centerX() - mCropViewRect.width() / 2;
        float y1 = mCropViewRect.centerY() - mCropViewRect.height() / 2;
        float x2 = mCropViewRect.centerX() + mCropViewRect.width() / 2;
        float y2 = mCropViewRect.centerY() - mCropViewRect.height() / 2;
        float x3 = mCropViewRect.centerX() + mCropViewRect.width() / 2;
        float y3 = mCropViewRect.centerY() + mCropViewRect.height() / 2;
        float x4 = mCropViewRect.centerX() - mCropViewRect.width() / 2;
        float y4 = mCropViewRect.centerY() + mCropViewRect.height() / 2;

        if (mShowCropFrame) {
            canvas.drawRect(mCropViewRect, mCropFramePaint);
            //draw corner 1
            canvas.drawLine(x1 - 7, y1 - 14, x1 - 7, y1 + 50, mCropGridPaint);
            canvas.drawLine(x1 - 14, y1 - 7, x1 + 50, y1 - 7, mCropGridPaint);
            //draw corner 2
            canvas.drawLine(x2 + 7, y2 - 14, x2 + 7, y2 + 50, mCropGridPaint);
            canvas.drawLine(x2 + 14, y2 - 7, x2 - 50, y2 - 7, mCropGridPaint);
            //draw corner 3
            canvas.drawLine(x3 + 7, y3 + 14, x3 + 7, y3 - 50, mCropGridPaint);
            canvas.drawLine(x3 + 14, y3 + 7, x3 - 50, y3 + 7, mCropGridPaint);
            //draw corner 4
            canvas.drawLine(x4 - 7, y4 + 14, x4 - 7, y4 - 50, mCropGridPaint);
            canvas.drawLine(x4 - 14, y4 + 7, x4 + 50, y4 + 7, mCropGridPaint);
        }
...
//        }
    ...
    /**
     * This method setups Paint object for the ucrop_ic_rotate bounds.
     */
    @SuppressWarnings("deprecation")
    private void initCropFrameStyle(@NonNull TypedArray a) {
        ...
        int cropFrameColor = getResources().getColor(R.color.ucrop_color_white);
//        int cropFrameColor = getResources().getColor(R.color.ucrop_color_default_crop_frame);
    ...
    /**
     * This method setups Paint object for the ucrop_ic_rotate guidelines.
     */
    @SuppressWarnings("deprecation")
    private void initCropGridStyle(@NonNull TypedArray a) {
        int cropGridStrokeSize = 6;
        int cropGridColor = getResources().getColor(R.color.ucrop_color_white);
