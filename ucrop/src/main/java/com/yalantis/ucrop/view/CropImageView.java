 ...
 * <p/>
 * This class adds ucrop_ic_rotate feature, methods to draw ucrop_ic_rotate guidelines, and keep image in correct state.
...
//    private static List<Float> listScale = new ArrayList<>();
...
//        setImageToWrapCropBounds(false);
    ...
    /**
     * @return - maximum scale value for current image and ucrop_ic_rotate ratio
     */
    ...
    /**
     * @return - minimum scale value for current image and ucrop_ic_rotate ratio
     */
    ...
    /**
     * @return - aspect ratio for ucrop_ic_rotate bounds
     */
    ...
    /**
     * Updates current ucrop_ic_rotate rectangle with given. Also recalculates image properties and position
     * to fit new ucrop_ic_rotate rectangle.
     *
     * @param cropRect - new ucrop_ic_rotate rectangle
     */
    ...
    /**
     * This method sets animation duration for image to wrap the ucrop_ic_rotate bounds
     *
...
//    public void postFlip(boolean flipRight) {
//        postFlip(flipRight, mCropRect.centerX(), mCropRect.centerY());
//
//    }
...
//    public void resetImageToWrapCropBounds() {
//        listScale.add(getCurrentScale() - scale);
//        zoomInImage(listScale.get(0));
//    }

    /**
     * If image doesn't fill the ucrop_ic_rotate bounds it must be translated and scaled properly to fill those.
     * <p/>
     ...
     * Scale value must be calculated only if image won't fill the ucrop_ic_rotate bounds after it's translated to the
     * ucrop_ic_rotate bounds rectangle center. Using temporary variables this method checks this case.
     */
...
//            if (mBitmapLaidOut && !isImageWrapCropBounds()) {
            ...
            if (willImageWrapCropBoundsAfterTranslate) {
                ...
                Log.d("Haipd", "setImageToWrapCropBounds: " + currentScale);
//                scale = deltaScale;
...
//            }
    ...
    /**
     * First, un-rotate image and ucrop_ic_rotate rectangles (make image rectangle axis-aligned).
    ...
    /**
     * When image is laid out it must be centered properly to fit current ucrop_ic_rotate bounds.
     */
    @Override
    ...
    /**
     * This method checks whether current image fills the ucrop_ic_rotate bounds.
     */
     ...
     * fills the ucrop_ic_rotate bounds rectangle.
     *
     * @param imageCorners - corners of a rectangle
     * @return - true if it wraps ucrop_ic_rotate bounds, false - otherwise
     */
    ...
    /**
     * This Runnable is used to animate an image so it fills the ucrop_ic_rotate bounds entirely.
