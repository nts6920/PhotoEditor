...
/**
 * Crops part of image that fills the ucrop_ic_rotate bounds.
 * <p/>
...
public class BitmapCropTask extends AsyncTask<Void, Void, Throwable> {
    ...
    private boolean crop(float resizeScale) throws IOException {
        ...
        Log.i(TAG, "Should ucrop_ic_rotate: " + shouldCrop);
     ...
     *
     * @param width  - ucrop_ic_rotate area width
     * @param height - ucrop_ic_rotate area height
